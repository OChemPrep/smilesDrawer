...
class Drawer {
    ...
    constructor(options) {
        ...
        this.generatedSmilesOutput = null;
     ...
     * @param {Boolean} textOnly=false "Only" output SmilesString for the molecule without drawing anything to the canvas.
     */

    layout(data, infoOnly = false, textOnly = false) {
        //begin of initDraw
        this.data = data;
